...
export default function StratoLandingPage() {
  ...
  return (
    <div className="font-sans text-foreground bg-background">
      ...
      {/* Header */}
      <header className="flex justify-between items-center px-4 py-2 md:px-6 md:py-4 shadow-sm border-b sticky top-0 bg-background/95 backdrop-blur-sm z-50 min-h-[60px]">
        <div className="flex items-center space-x-3">
          {/* Light mode logo */}
          <img 
            src="/strato white logo.png" 
            alt="Strato Logo Light" 
            className="h-14 md:h-24 lg:h-28 w-auto object-contain dark:hidden transition-all duration-300"
          />
          <img 
            src="/strato logo.png" 
            alt="Strato Logo Dark" 
            className="h-14 md:h-24 lg:h-28 w-auto object-contain hidden dark:block transition-all duration-300"
          />
